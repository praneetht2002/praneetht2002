...
#data preprocessing
data=ps.read_csv(r"C:\\Users\\thudi\\OneDrive\\Major_project\Bigmart.csv")
...
plt.plot(K,inertias)
plt.savefig(os.path.join("C://Users//thudi//OneDrive//Major_project","elbow_curve.png"))
plt.show()
...
plt.legend()
plt.savefig(os.path.join("C://Users//thudi//OneDrive//Major_project","clusters.png"))
